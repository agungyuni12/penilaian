          ...
          <div class="text-center" style="width: 100%; ">
              <div class="row">
                <div class="form-group">
                  <a href="nilaippl.php" class="btn btn-outline-primary form-control" role="button" aria-pressed="true">PPL</a>
                </div>
                <div class="form-group mt-3">
                  <a href="nilaipml.php" class="btn btn-outline-primary form-control" role="button" aria-pressed="true">PML</a> 
                </div>
              </div>
          </div>
